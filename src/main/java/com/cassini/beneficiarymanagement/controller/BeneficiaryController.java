...
public class BeneficiaryController {
	 ...
	 * 
	 * @param customerId.By passing the customerId as a pathvariable the beneficiaries of current 
	 ...
	 * 
	 * @throws AccountNotFoundException This exception occurs when account does not found
	 * 
	 * @throws MaximumBeneficiaryException This exception occurs when beneficiary list 
	 * exceeds the limit of 10 beneficiaries
	 * 
	 * @throws UserNotFoundException This exception occurs when user does not found while adding beneficiary
	 * @throws BeneficiaryAlreadyExistException This exception occurs when beneficiary already exists while adding new one
	 */
	 ...
	 * 
	 * @throws BeneficiaryNotFoundException This exception occurs when
	 ...
	 * 
	 * @param beneficiaryId.By passing the beneficiaryId the unwanted beneficiary can be deleted
	 *  
	 * @return This returns the messageDto which includes message and statuscode
	 * @throws BeneficiaryNotFoundException This exception occurs when beneficiary does not found
	 */
