...
public class BankServiceImpl implements BankService {
	 ...
	 * 
	 * By passing ifsc code as a path variable the bank details could be fetched from the database
	 * 
	 * This returns the bank details 
	 * BankNotFound This exception is occurs when bank not found while searching banks
	 */
